namespace Core.Data
{
        ...
        public class DapperContext : IDapperContext //, IInternalContext
    {
        ...
        //simple crud utilizzo della libreria

        // INSERT
        public int? Insert<T>(T entity) where T : class
        {
            return this.InternalConnection.Insert(entity, this.InternalTransaction);
        }

        // GET by ID
        public T Get<T>(object id) where T : class
        {
            return this.InternalConnection.Get<T>(id, this.InternalTransaction);
        }

        // GET ALL
        public IEnumerable<T> GetList<T>(object whereConditions = null) where T : class
        {
            return this.InternalConnection.GetList<T>(whereConditions, this.InternalTransaction);
        }

        // UPDATE
        public int Update<T>(T entity) where T : class
        {
            return this.InternalConnection.Update(entity, this.InternalTransaction);
        }

        // DELETE by entity
        public int Delete<T>(T entity) where T : class
        {
            return this.InternalConnection.Delete(entity, this.InternalTransaction);
        }

        // DELETE by ID
        public int Delete<T>(object id) where T : class
        {
            return this.InternalConnection.Delete<T>(id, this.InternalTransaction);
        }

        // DELETE with WHERE
        public int DeleteList<T>(object whereConditions) where T : class
        {
            return this.InternalConnection.DeleteList<T>(whereConditions, this.InternalTransaction);
        }

        // RECORD COUNT
        public int RecordCount<T>(object whereConditions = null) where T : class
        {
            return this.InternalConnection.RecordCount<T>(whereConditions, this.InternalTransaction);
        }

        public Task<int?> InsertAsync<T>(T entity) where T : class
        {
            return this.InternalConnection.InsertAsync(entity, this.InternalTransaction);
        }

        public Task<T> GetAsync<T>(object id) where T : class
        {
            return this.InternalConnection.GetAsync<T>(id, this.InternalTransaction);
        }

        public Task<IEnumerable<T>> GetListAsync<T>(object whereConditions = null) where T : class
        {
            return this.InternalConnection.GetListAsync<T>(whereConditions, this.InternalTransaction);
        }

        public Task<int> UpdateAsync<T>(T entity) where T : class
        {
            return this.InternalConnection.UpdateAsync(entity, this.InternalTransaction);
        }

        public Task<int> DeleteAsync<T>(T entity) where T : class
        {
            return this.InternalConnection.DeleteAsync(entity, this.InternalTransaction);
        }

        public Task<int> DeleteAsync<T>(object id) where T : class
        {
            return this.InternalConnection.DeleteAsync<T>(id, this.InternalTransaction);
        }

        public Task<int> DeleteListAsync<T>(object whereConditions) where T : class
        {
            return this.InternalConnection.DeleteListAsync<T>(whereConditions, this.InternalTransaction);
        }

        public Task<int> RecordCountAsync<T>(object whereConditions = null) where T : class
        {
            return this.InternalConnection.RecordCountAsync<T>(whereConditions, this.InternalTransaction);
        }
