namespace Core.Data
{
    ...
    using System.Threading.Tasks;
        ...
        IEnumerable<T> GetList<T>(object whereConditions = null) where T : class;
        ...
        int RecordCount<T>(object whereConditions = null) where T : class;

        Task<int?> InsertAsync<T>(T entity) where T : class;

        Task<T> GetAsync<T>(object id) where T : class;

        Task<IEnumerable<T>> GetListAsync<T>(object whereConditions = null) where T : class;
        ...
        Task<int> DeleteListAsync<T>(object whereConditions) where T : class;

        Task<int> RecordCountAsync<T>(object whereConditions = null) where T : class;
